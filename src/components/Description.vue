                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md-7 mr-auto card-mobile">
                            ...
                            <a :href="getUrl(user.resume)" target="_blank" download>
                              <b-button size="lg">Download Resume <font-awesome-icon class="fa-2x" icon="download"/></b-button>
                            </a>
                        </div>
...
export default {
        ...
        methods: {
          getUrl(file) {
            return require('../assets/resume/' + file);
          },
        }
    }
</script>
